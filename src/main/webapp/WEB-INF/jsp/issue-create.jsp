...
<body>
    ...
    <form action="<%= request.getContextPath() %>/issues/create" method="post">
        ...
        <div class="field">
            ...
            <input id="customer" name="customer" type="text" maxlength="255" required>
        </div>
        <div class="field">
            <label for="product">製品・プロジェクト</label>
            <input id="product" name="product" type="text" maxlength="255" required>
        </div>
        <div class="field">
        ...
        <div class="field">
            ...
            <input id="progress" name="progress" type="number" min="0" max="100" value="0" required>
        </div>
        <div class="field">
            <label for="assignee">担当者</label>
            <input id="assignee" name="assignee" type="text" maxlength="255" required>
        </div>
        <div class="field">
